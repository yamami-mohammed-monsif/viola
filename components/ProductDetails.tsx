  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div>
        ...
        <p
          className="font-cairo text-sm leading-relaxed"
      ...
      <div className="flex items-center gap-3">
        <span
          className="font-cairo font-bold text-2xl"
        ...
        {config.originalPrice && (
          <span
            className="font-cairo text-base line-through"
            style={{ color: "var(--color-muted)" }}
          >
            {config.originalPrice}
          </span>
        ...
        {config.originalPrice && (
          ...
          >
            وفري{" "}
            {Math.round(
              parseInt(config.originalPrice.replace(/\D/g, "")) -
                parseInt(config.price.replace(/\D/g, "")),
      ...
      <div>
        <p
          className="font-cairo text-sm font-semibold mb-2"
                ...
                style={{
                  borderColor:
                    selectedSet === s
                      ...
                      : "var(--color-muted)",
                  background:
                    selectedSet === s ? "var(--color-primary)" : "transparent",
                }}
              />
              {s}
            </button>
